...
const CharInfoCard = ({char}) => {
    ...
    return (
        <div className="bg-[#30364F] text-[#E1D9BC] border border-[#4a5568] rounded-lg p-4 shadow-lg hover:cursor-pointer relative hover:scale-[1.02] transition-transform duration-300" 
