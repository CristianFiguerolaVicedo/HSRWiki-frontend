...
const CharList = () => {
    ...
    const regularChars = sortedCharacters.filter(char => 
        !char.name.includes('Trailblazer')
    );
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 mt-4">
                        ...
                        <div className="text-gray-400">
                            Showing <span className="text-white font-semibold">{sortedCharacters.length}</span> characters
                        </div>
                    </div>
                </div>
                ...
                {sortedCharacters.length === 0 && (
                    <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-xl p-12 border border-gray-700 text-center mb-8">
                        ...
                        <h3 className="text-2xl font-bold mb-3 text-gray-300">No characters found</h3>
